...
export class ScoresController {
  ...
  @ApiOperation({
    ...
    description:
      "Returns the health status and available features of the scores calculation service",
  })
  @ApiResponse({
    status: 200,
    ...
    schema: {
      ...
      properties: {
        ...
        features: {
          type: "array",
          items: { type: "string" },
          example: ["5-judge", "7-judge", "fina-rules"],
        },
      },
    },
  })
  ...
  @ApiOperation({
    ...
    description:
      "Calculates individual scores and returns the total competition score across all dives.",
  })
  @ApiBody({ type: [CalculateScoreDto] })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      "Process multiple dive calculations in a single request. Returns an array of results.",
  })
